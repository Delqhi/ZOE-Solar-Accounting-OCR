/**
 * desigOS Component Library
 * Auto-generated for Claude Code integration
 */

export const desigOS = {
  // Design Tokens
  tokens: {
    colors: {
      primary: '#0066FF',
...
// Validation rules
export const DESIGOS_RULES = {
  colors: 'Use theme tokens only',
  spacing: '8px base unit',
  typography: 'Inter, system-ui, sans-serif',
  components: 'Use desigOS components when available'
};