                ...
                {filteredDocuments.map(doc => {
                    ...
                    return (
                        <div
                            ...
                            `}
                        >
                            <div className={`w-2 h-2 rounded-full flex-none ${isDup ? 'bg-[#666]' : isErr ? 'bg-[#666]' : isReview ? 'bg-[#666]' : (isActive ? 'bg-white' : 'bg-[#444]')}`}></div>
                            {!sidebarCollapsed && (
                            ...
                            {!sidebarCollapsed && isDup && (
                                <button
                                    ...
                                    className="p-1 text-[#888] hover:bg-[#333] hover:text-[#666] rounded transition-colors"
